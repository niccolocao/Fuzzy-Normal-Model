...
par(mai=c(1,2,0.5,2),mgp=c(3, 0.6, -0.2))
hist(menW,xlab= "Intensification parameter",main = "",cex.lab=2.25,cex.axis=1.75)
dev.off()

#Plot of the difference between lower-bounds and centroids
tikz('C:/Users/NC/Downloads/MDPI/fig3b.tex',width=8.5,height=10.5)
par(mai=c(1,2,0.5,2),mgp=c(3, 0.6, -0.2))
hist(menR-menC,xlab= "Lower Bounds-Centroids differences",main = "",cex.lab=2.25,cex.axis=1.75)
dev.off()

#Plot of the difference between centroids and upper-bounds
tikz('C:/Users/NC/Downloads/MDPI/fig3c.tex',width=8.5,height=10.5)
par(mai=c(1,2,0.5,2),mgp=c(3, 0.6, -0.2))
hist(menC-menL,xlab= "Centroids-Upper Bounds differences",main = "",cex.lab=2.25,cex.axis=1.75)
dev.off()



library(vioplot)
par(mai=c(1,1,1,1),mgp=c(3, 1, 0))
vioplot(menRTS)
